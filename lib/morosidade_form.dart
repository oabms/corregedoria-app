...
class MorosidadeFormScreen extends StatefulWidget {
  const MorosidadeFormScreen({Key? key}) : super(key: key);
  @override
  _MorosidadeFormScreenState createState() => _MorosidadeFormScreenState();
}

class _MorosidadeFormScreenState extends State<MorosidadeFormScreen> {
  ...
  final _formMorosidade = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      navigationBar: CupertinoNavigationBar(
        ...
        middle: const Text("Morosidade de Processo",
      ...
      child: Padding(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              // Adicione os campos do formulário para a opção "Morosidade de Processo" aqui
              TextFormField(
              ...
              PlatformElevatedButton(
                onPressed: () {
                  if (_formMorosidade.currentState!.validate()) {
                    String solicitacao =
                        'Corregedoria Aplicativo'; // Departamento de destino do email
                    String assunto =
                        'Novo formulário de morosidade de processo preenchido.';
                    String conteudo = '''
                          Nome: ${_nomeController.text}
                          Nº OAB: ${_numeroOABController.text}
                          E-mail: ${_emailController.text}
                          Telefone Celular: ${_phoneController.text}
                          Número do processo/inquérito: ${_numProcessoController}
                          Breve relato: ${_relatoController.text}
                        ''';
                    String conteudoHTML = '''
                          <h1>Corregedoria Geral OAB/MS</h1>
                          <h2>Novo formulário de Morosidade de Processo preenchido</h2>
                    ...
                    enviarEmail(solicitacao, assunto, conteudo, conteudoHTML,
                        _selectedFile);
